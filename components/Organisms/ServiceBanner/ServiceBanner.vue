<template>
  <div class="px-4 py-18 md:py-25 md:px-0">
    ...
    <div class="gap-4 md:bg-accent-50 px-4">
      <div class="grid md:grid-cols-4 md:gap-4 lg:py-8">
        <div
          v-for="(section, sectionIndex) in sections"
          :key="'section-' + sectionIndex"
          :class="{
            'w-full md:w-auto md:mb-0 py-4 px-2 section-bar border-b-[1px] border-accent-950 md:border md:rounded-lg bg-accent-50':
              sectionIndex !== sections.length - 1,
            'w-full md:w-auto md:mb-0 py-4 px-2 section-bar bg-accent-50 md:border md:border-accent-950 md:rounded-lg':
              sectionIndex === sections.length - 1,
          }"
