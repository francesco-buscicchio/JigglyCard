  ...
  <div class="gap-4">
    <div class="grid md:grid-cols-4 md:gap-4 lg:py-8">
      <div
        ...
        :class="{
          'w-full md:w-auto md:mb-0 py-4 px-2 section-bar border-b-[1px] border-accent-950 md:border-none bg-accent-50':
            sectionIndex !== sections.length - 1,
          'w-full md:w-auto md:mb-0 py-4 px-2 section-bar md:border-none bg-accent-50':
            sectionIndex === sections.length - 1,
        }"
          ...
          <div class="flex-1 max-w-[75%] min-w-[75%] px-3">
            ...
            <div v-if="Array.isArray(section.sections)" class="pb-2">
              <div v-for="(item, index) in section.sections" :key="index">
                ...
                <label v-else class="line-clamp-3" for="item">{{ item }}</label>
              </div>
            </div>
            <div v-else>
